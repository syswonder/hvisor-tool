...
static int rpmsg_create_eptdev(char *eptdev_name,
...
int main(int argc, char const *argv[])
{
    ...
    // ret = rpmsg_create_eptdev("rpmsg-master-a53", RPMSG_MASTER_ADDR, RPMSG_REMOTE_ADDR);
    ret = rpmsg_create_eptdev("rpmsg-remote-m7", RPMSG_MASTER_ADDR, RPMSG_REMOTE_ADDR);
